...
import { Mail, Lock, Loader2, ArrowRight, Bookmark } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-zinc-50 font-sans selection:bg-indigo-500/10">
            ...
            <div className="hidden lg:flex flex-col items-center justify-center relative overflow-hidden bg-gradient-to-br from-indigo-700 via-indigo-800 to-violet-950 p-16 text-white">
                ...
                <div className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] bg-indigo-500/10 rounded-full blur-[100px]"></div>
                ...
                <div className="relative z-10 text-center max-w-sm space-y-6">
                    ...
                    <p className="text-indigo-100 text-lg font-medium opacity-90 animate-in slide-in-from-bottom-4 duration-700 delay-300">
                        ...
                        <br />
                        <span className="text-indigo-200/60 text-sm mt-4 inline-block font-bold uppercase tracking-widest">v2.0 Protocol</span>
                    </p>
                </div>
            </div>
            ...
            <div className="flex items-center justify-center p-8 lg:p-16">
                <div className="w-full max-w-[420px] animate-in slide-in-from-right-4 duration-700">
                    ...
                    <div className="bg-white p-8 lg:p-10 rounded-3xl shadow-xl shadow-zinc-200/50 border border-zinc-200/60">
                        <div className="mb-8">
                            ...
                            <p className="text-zinc-500 mt-2 font-medium">Please enter your credentials to access your library.</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-2">
                                <label className="text-[11px] font-bold text-zinc-500 uppercase tracking-widest ml-1">Identity (Email)</label>
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        placeholder="curator@smartmark.io"
                                        value={email}
                        ...
                        <div className="mt-8 pt-6 border-t border-zinc-100 text-center">
                            <p className="text-zinc-500 font-medium text-sm">
                                Not a member yet?{' '}
                                <Link to="/register" className="text-indigo-600 hover:text-indigo-700 font-bold hover:underline underline-offset-4 decoration-2 transition-all ml-1">
                                    Initialize Account
                                </Link>
                            </p>
                        </div>
                    ...
                    <p className="text-center mt-8 text-zinc-400 text-xs font-bold uppercase tracking-widest">
                        Admin Protocol &copy; 2026 SmartMark
                    </p>
                </div>
            </div>
        </div>
